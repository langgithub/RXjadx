...
.method static a(Lio/fabric/sdk/android/services/concurrency/m;Ljava/lang/Object;)I
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<Y:",
    ...
    .line 1
    instance-of v0, p1, Lio/fabric/sdk/android/services/concurrency/m;

    if-eqz v0, :cond_b

    .line 2
    check-cast p1, Lio/fabric/sdk/android/services/concurrency/m;

    invoke-interface {p1}, Lio/fabric/sdk/android/services/concurrency/m;->getPriority()Lio/fabric/sdk/android/services/concurrency/Priority;
    ...
    invoke-interface {p0}, Lio/fabric/sdk/android/services/concurrency/m;->getPriority()Lio/fabric/sdk/android/services/concurrency/Priority;
