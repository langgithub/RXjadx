...
.method constructor <init>(ILokhttp3/internal/http2/Http2Connection;ZZLokhttp3/D;)V
    .registers 8
...
.method public readTimeout()Lokio/D;
    .registers 2
...
.method receiveData(Lokio/i;I)V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p1, v1, v2}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receive(Lokio/i;J)V
...
.method receiveHeaders(Ljava/util/List;)V
    ...
    invoke-static {p1}, Lokhttp3/internal/Util;->toHeaders(Ljava/util/List;)Lokhttp3/D;
...
.method public declared-synchronized takeHeaders()Lokhttp3/D;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public writeTimeout()Lokio/D;
    .registers 2
